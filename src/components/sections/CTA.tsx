    ...
    <Section paddingY="xl" className="bg-gradient-to-br from-solar-orange via-solar-orange to-eco-green relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Heading
            as="h2"
            className="text-white mb-6 leading-tight text-4xl lg:text-5xl xl:text-6xl"
          >
            Готови ли сте да преминете <br className="hidden lg:block" />
            към соларна енергия?
          </Heading>
          ...
          >
            Свържете се с нас днес за безплатна консултация и персонализирана
            оферта. Нашият екип от експерти ще ви помогне да изберете
            най-доброто решение.
          </Text>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Button href="tel:+359888123456" variant="secondary" size="lg">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
