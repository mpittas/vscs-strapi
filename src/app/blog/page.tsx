...
const fallbackPosts = [
  {
    ...
    excerpt:
      "With new tax incentives, improved technology, and rising electricity costs, there's never been a better time to switch to solar energy. Discover why smart homeowners are making the switch now.",
  ...
  },
  {
    ...
    excerpt:
      "Not all solar panels are created equal. Learn how to evaluate panel efficiency ratings and what they mean for your energy production and savings over time.",
    author: "David Chen",
  ...
  },
  {
    ...
    excerpt:
      "Solar batteries have changed the game for homeowners. Discover how adding battery storage to your solar system can maximize savings and provide energy independence.",
  ...
  },
  {
    ...
    excerpt:
      "Federal and state tax incentives can significantly reduce your solar installation costs. Here's everything you need to know about claiming your solar tax credits.",
  ...
  },
  {
    ...
    excerpt:
      "Thinking about solar for your business? We break down the numbers, timeline, and real-world returns you can expect from a commercial solar installation.",
    author: "David Chen",
  ...
  },
  {
    ...
    excerpt:
      "Solar panels are low-maintenance, but not no-maintenance. Learn the essential tips for keeping your solar system running at maximum efficiency for decades.",
    author: "Sarah Martinez",
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-slate-300 max-w-2xl">
              Stay informed about the latest in solar technology, industry
              trends, and tips to maximize your solar investment.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="container">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-muted mb-6">{posts[0].excerpt}</p>
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted mb-8">
              Subscribe to our newsletter for the latest solar news, tips, and
              exclusive offers.
            </p>
